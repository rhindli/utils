...
rm -fr $DEST_WORKSPACE/jclient
rm -fr $DEST_WORKSPACE/jclientEar
rm -fr $DEST_WORKSPACE/lib
rm -fr $DEST_WORKSPACE/pbit
rm -fr $DEST_WORKSPACE/pirw
rm -fr $DEST_WORKSPACE/prks
rm -fr $DEST_WORKSPACE/prop
rm -fr $DEST_WORKSPACE/pmod
...
cp -r $SOURCE_WORKSPACE/jclient $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/jclientEar $DEST_WORKSPACE
...
cp -r $SOURCE_WORKSPACE/prop $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/pmod $DEST_WORKSPACE
