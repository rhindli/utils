...
rm -fr $DEST_WORKSPACE/paer
rm -fr $DEST_WORKSPACE/paur
rm -fr $DEST_WORKSPACE/pavg
rm -fr $DEST_WORKSPACE/pbit
rm -fr $DEST_WORKSPACE/pcsd
rm -fr $DEST_WORKSPACE/pf64
rm -fr $DEST_WORKSPACE/pirw
rm -fr $DEST_WORKSPACE/pmed
rm -fr $DEST_WORKSPACE/pmod
rm -fr $DEST_WORKSPACE/prds
...
cp -r $SOURCE_WORKSPACE/paer $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/paur $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/pavg $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/pbit $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/pcsd $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/pf64 $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/pirw $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/pmed $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/pmod $DEST_WORKSPACE
cp -r $SOURCE_WORKSPACE/prds $DEST_WORKSPACE
